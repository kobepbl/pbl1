...
class Cart extends DbData
{
  ...
  {
    $sql = "select items.ident, items.name, items.maker, items.price, cart.quantity, items.image, items.genre from
    cart join items on cart.ident = items.ident where cart.userId = ?";
