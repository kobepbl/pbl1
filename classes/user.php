...
class Article_comment extends DbData{
    public function Insertarticle($user_id,$article_id,$comment,$creation_date){

        $sql = "insert into article_list(user_id,article_id,comment,creation_date) values(?, ?, ?, ?)";
        $result = $this->exec($sql,[$user_id,$article_id,$comment,$creation_date]);
